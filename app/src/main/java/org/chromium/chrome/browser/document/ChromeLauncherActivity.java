...
public class ChromeLauncherActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        AppUtils.showLogInfo("ChromeLauncherActivity inside :: ");
        ...
        try {
            ...
            switch (dispatchAction) {
                case LaunchIntentDispatcher.Action.FINISH_ACTIVITY:
                    finish();
                    AppUtils.showLogInfo("ChromeLauncherActivity inside FINISH TASK:: ");
                    break;
                case LaunchIntentDispatcher.Action.FINISH_ACTIVITY_REMOVE_TASK:
                    ApiCompatibilityUtils.finishAndRemoveTask(this);
                    AppUtils.showLogInfo("ChromeLauncherActivity inside REMOVE TASK:: ");
                    break;
                default:
