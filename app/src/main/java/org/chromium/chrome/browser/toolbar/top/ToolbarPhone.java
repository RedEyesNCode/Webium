...
import org.chromium.utilsKodium.AppUtils;
...
public class ToolbarPhone extends ToolbarLayout implements Invalidator.Client, OnClickListener,
    ...
    public void onClick(View v) {
        ...
        if (mHomeButton != null && mHomeButton == v) {
            ...
            // KODIUM EDIT : THIS IS THE FUNCTION WHICH IS CALLED WHENEVER WE CLICK ON THE HOME BUTTON WE
            // JUST NEED TO PASS THE CUSTOM INTENT TO OUR ACTIVITY NOW.
            Intent startCustomIntent = new Intent(getContext(), JoinMeetingActivity.class);
            getContext().startActivity(startCustomIntent);
            AppUtils.showLogInfo("CLICKED ON HOME BUTTON");
            //YOU CAN PASS THE INTENT HERE TO OPEN THE
    ...
    private void addHomeButton() {
        mHomeButton.setVisibility(
                urlHasFocus() || isTabSwitcherAnimationRunning() ? VISIBLE : VISIBLE);
