...
//                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
    ...
    private boolean openCurrentUrlInChrome() {
        ...
        AppUtils.showLogInfo("WEBAPP_ACTIVITY_LINE_823");
        AppUtils.showLogInfo("MODIFIED THE DEFAULT LOOK");
        AppUtils.showLogInfo("MODIFIED THE DEFAULT LOOK");

        //Modify this to open a default url on every new tab click and also when the chrome app is lauched.
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://meet.toktown.tk/gkOlyl"));
//        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
