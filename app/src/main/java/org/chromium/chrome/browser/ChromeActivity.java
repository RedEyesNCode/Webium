...
import kodiumCode.splash.SplashActivity;
...
public abstract class ChromeActivity<C extends ChromeActivityComponent>
    ...
    */
    ...
    public final void onBackPressed() {
        ...
        AppUtils.showLogInfo("Handled Back press to return to your own activity of your app");
       /* Intent chromeIntent = new Intent(getApplicationContext(), JoinMeetingActivity.class);
